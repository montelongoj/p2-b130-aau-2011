\section{Discussion}
The focus in this discussion is to see if the product is in conjunction with the problem analysis \fxfatal{ref til problem analysis} and to see if the different requirements \fxfatal{ref til specification requirements} is integrated in the product.
