...
Figure \ref{fig:skitse3a} shows how the idea were before the coding of the program began. The idea was that the suitcase would be shown and then one item  would be drawn at a time. The user would then be able to see where each item should be in the suitcase according to the program.
...
\figur{1.0}{8.skitse.jpg}{Sketch of the message box that will be shown when the items have been packed}{fig:skitse8}
