...
\figur{0.8}{Mainwindow.png}{Main window}{fig:Main}
...
\figur{0.8}{ManageItems.png}{Manage items window}{fig:ManageItems}
The Manage Items menu is where the user can add, delete and/or edit items.

\figur{0.8}{ManageSuitcase.png}{Manage suitcase window}{fig:ManageSuitcase}
...
\figur{0.5}{AddItem.png}{Add item window}{fig:AddItem}
...
\figur{0.3}{AddSuitcase.png}{Add suitcase window}{fig:AddSuitcase}
...
\figur{0.3}{EditItem.png}{Edit item window}{fig:EditItem}
...
\figur{0.3}{EditSuitcase.png}{Edit suitcase window}{fig:EditSuitcase}
...
\figur{0.6}{frm3DViewer2.png}{3D Viewer2 window}{fig:3dViewer2}
