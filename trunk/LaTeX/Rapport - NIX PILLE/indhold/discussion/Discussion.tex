...
%\end{itemize}
All the requirements (see section \ref{sec:spec}) have been meet, which can be seen as a success. The program can deal with many of the problems found in the process analysis. The program can help the user in the process of packing a suitcase, and will by a simple interface pack the suitcase, where the user did have a problem packing it by their own.
