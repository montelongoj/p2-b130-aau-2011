...
The program are then tested on the targeted group that was found affected by the problem. The testing leads to a conclusion of the project. This is main course of the project work when using the Aalborg PBL. %skal vi ikke komme ind på Aalborg PBL ligt mere en bare at nævne den? 
