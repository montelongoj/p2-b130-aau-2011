...
\figur{0.9}{4skitsedone.jpg}{Sketch of the window which appears if the user clicks the "New packing list"-button}{fig:skitse4done}
...
\figur{0.9}{5skitsedone.jpg}{Window opens when the user adds new items}{fig:skitse5done}

Figure \ref{fig:skitse5done} shows how the user can add the items he/she wants packed to a list. After the user has added all the items the "View list"-button will show a list with all the items and afterwards return the user to the main window.

\figur{0.9}{6skitsedone.jpg}{Sketch of a window which shows the saved lists}{fig:skitse6done}
...
\figur{0.4}{8skitse.jpg}{Sketch of the message box which will be shown when the items have been packed}{fig:skitse8}
